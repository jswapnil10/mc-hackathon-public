...
class DashboardTests(unittest.TestCase):
    ...
    def test_home_page_loads(self):
        ...
        self.assertIn(b"lab.js?v=20260831-5", response.data)
        ...
        self.assertIn(b"loadReplayFromUrl", script.data)
        self.assertIn(b"rememberReplayInUrl", script.data)
    ...
    def test_evidence_and_run_guide_routes_load_complete_workspaces(self):
        ...
        self.assertIn(b"evidence.js?v=20260831-5", evidence.data)
